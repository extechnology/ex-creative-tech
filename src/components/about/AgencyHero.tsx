...
export default function AgencyHero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden bg-[#050505] text-white">
      {/* Ambient Red & Purple Gradient Blur Blobs */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] bg-gradient-to-tr from-red-600/20 via-purple-600/25 to-indigo-600/10 rounded-full blur-[120px] pointer-events-none z-0 opacity-70" />
      <div className="absolute top-1/3 -right-20 w-80 h-80 bg-red-500/15 rounded-full blur-[100px] pointer-events-none z-0" />
      <div className="absolute bottom-10 -left-20 w-80 h-80 bg-purple-600/15 rounded-full blur-[100px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            >
              We are an award-winning digital design & engineering studio crafting high-impact platforms, brand identities, and futuristic web experiences for visionary tech teams worldwide.
            </motion.p>
            ...
            >
              <a
                href="#our-story"
                className="group relative inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-white text-black font-medium text-sm hover:bg-white/90 transition-all duration-300 shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] hover:scale-[1.02] active:scale-[0.98]"
              >
                <span>Our Story</span>
          ...
          {/* Right Hero Image Column with Floating Stat Cards */}
